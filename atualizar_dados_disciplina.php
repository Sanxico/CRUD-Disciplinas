<?php
	...
	$sql_atualiza = "UPDATE disciplina SET id='$id', codigo_disciplina='$codigo_disciplina', nome_disciplina='$nome_disciplina', campus='$campus', unidade_academica='$unidade_academica', departamento='$departamento', carga_horaria='$carga_horaria', id='$id' WHERE id='$id'";
